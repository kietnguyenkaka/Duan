import '../discoverten_container_page/widgets/discovertencontainer_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:vip_app/core/app_export.dart';
import 'package:vip_app/widgets/app_bar/appbar_subtitle_five.dart';
import 'package:vip_app/widgets/app_bar/appbar_subtitle_one.dart';
import 'package:vip_app/widgets/app_bar/appbar_trailing_image.dart';
import 'package:vip_app/widgets/app_bar/custom_app_bar.dart';

class DiscovertenContainerPage extends StatelessWidget {
  const DiscovertenContainerPage({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: Padding(
            ...
            child: Column(children: [
              AppbarSubtitleOne(text: "lbl_h_m_nay_th_7".tr),
              SizedBox(height: 2.v),
              AppbarSubtitleFive(
                  ...
                  child: SizedBox(
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return DiscovertencontainerItemWidget();
                          }))),
              Padding(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(ImageConstant.imgGroup422),
                    fit: BoxFit.cover)),
  ...
  /// Navigates to the tipselevenScreen when the action is triggered.
  onTapCCTipsCho(BuildContext context) {
    Navigator.popAndPushNamed(context, AppRoutes.tipselevenScreen);
  }

  /// Navigates to the profilesixteenScreen when the action is triggered.
  ToPro5(BuildContext context) {
    Navigator.popAndPushNamed(context, AppRoutes.profilesixteenScreen);
  }
}
